...
export default function Navbar() {
  ...
  const marqueeText =
    "🌺 GANESH CHATURTHI SPECIAL: USE CODE 'FLAT30' FOR ₹30 OFF! 🌺 • EVERY ORDER INCLUDES • CUSTOM GENZONIC KEYCHAIN • BRAND STORY CARD • CUSTOM PATCH & STICKERS • PREMIUM UTILITY BOX • MORE THAN JUST APPAREL — IT’S AN EXPERIENCE • ";
      ...
      <div className={`mobile-sidebar-clean ${mobileMenuOpen ? "open" : ""}`}>
        <div className="sidebar-scroll-wrapper">
          ...
          <div className="clean-main-nav" style={{ display: "flex", flexDirection: "column", borderTop: "2px solid #000", borderBottom: "2px solid #000", background: "#fff" }}>
            ...
            {user?.role === "admin" && (
              <Link href="/custom-design" className="clean-nav-item primary-highlight" onClick={() => setMobileMenuOpen(false)} style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", width: "100%" }}>
                <span>CUSTOMIZER</span> <ChevronRight size={24} strokeWidth={2} style={{ display: "block", flexShrink: 0 }}/>
              </Link>
            )}
