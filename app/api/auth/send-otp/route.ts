...
// 4. Send the Email
    await transporter.sendMail({
      from: `"GenZonic Security" <${process.env.EMAIL_USER}>`,
      to: contact,
      replyTo: process.env.EMAIL_USER, // Adds legitimacy
      subject: `${otp} is your GenZonic Authorization Code`, // Better preview text
      // 🔥 CRITICAL FIX: Plain text fallback prevents spam flagging
      text: `GENZONIC\n\nYour secure authorization code is: ${otp}\n\nThis code expires in 10 minutes.`, 
      html: `
